...
(defvar org-project-files (directory-files-recursively org-project-directory org-agenda-file-regexp
                                                       nil #'my/one-level-down-predicate))
#+end_src

Find project files under =org-project-directory= and its direct descendent directories.

#+begin_src emacs-lisp
(defun my/find-in-projects ()
  (interactive)
  (let* ((default-directory (or org-project-directory org-directory)))
    (find-file
...
Creating a new project means creating a project directory under =org-project-directory= and adding a project file. Let's make an interactive command for this.
