...
Set title and heading font sizes.
...
**** Configuring browse-url 

#+begin_src emacs-lisp
(after! browse-url
  (setq browse-url-browser-function 'xwwp))
#+end_src
...
Let's bind some keybinds from evil-collections globally
...
#+begin_src emacs-lisp :tangle "packages.el"
(package! appine
  :recipe (:host github :repo "chaoswork/appine"))
#+end_src

#+begin_src emacs-lisp
(use-package! appine
  :config
  (setq appine-enable-open-in-org-mode t))
#+end_src
