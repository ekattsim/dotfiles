...
#+begin_src emacs-lisp
(after! ob-jupyter
  (setq my/jupyter-kernel-connection-file nil)
...
(use-package! elfeed
  ...
  (setq elfeed-feeds
        '("https://xkcd.com/rss.xml"
          ...
          "https://old.reddit.com/r/computerarchitecture.rss"
          "https://old.reddit.com/r/chipdesign.rss"
...
(use-package! gptel
  ...
  (setq gptel-model 'gemini-3.1-flash-lite-preview
        gptel-backend (gptel-make-gemini "Gemini" :key gptel-api-key
                     :stream t))
...
(gptel-make-preset 'general
    ...
    :system "You are a large language model and your job is to be a helpful assistant. Respond concisely and use the available tools if your knowledge is lacking or if explicitly directed by the user."
...
(use-package! xwwp
  ...
  :init
  (after! browse-url
    (setq browse-url-browser-function 'xwwp-other-window))
