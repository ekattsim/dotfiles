...
(defun my/apply-theme (appearance)
  ...
  (pcase appearance
    ('light (setq doom-theme 'doom-homage-white)
            (when (not (featurep 'nano-modeline))
                (load-file "/Users/abhijeetsurakanti/.config/doom/subconf/config-nano-modeline.el")
...
** agenda
#+call: confpkg(after="org-agenda", pre="define-project-dir")
...
Create a variable for the project directory.

#+name: define-project-dir
#+begin_src emacs-lisp
